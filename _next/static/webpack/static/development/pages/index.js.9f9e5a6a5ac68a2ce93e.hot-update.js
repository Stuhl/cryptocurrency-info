...
var calculateContent = function calculateContent(baseValue, divider) {
  console.log(baseValue, divider);
  return Math.floor(baseValue) / divider;
};

var FunFactItem = function FunFactItem(props) {
  var suffix = props.suffix ? props.suffix : "";
  console.log(calculateContent(props.baseValue, props.divider));
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Item, {
    ...
    __self: this
  }, calculateContent(props.baseValue, props.divider), " ", suffix));
};
...
//# sourceMappingURL=index.js.9f9e5a6a5ac68a2ce93e.hot-update.js.map